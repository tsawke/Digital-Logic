...
REM
REM Generated by Vivado on Wed Sep 17 20:50:17 +0800 2025
...
echo "xvlog --incr --relax -prj lab2_hw_tb_vlog.prj"
call xvlog  --incr --relax -prj lab2_hw_tb_vlog.prj -log xvlog.log
